...
class generujJsonFiles:
    ...
    def __init__(self, cestaHtmlSrc, cestaKTisku, nazevSouboruProGen, IdMulti, runJs):
        ...
        self.adresaJsonFile = 'C:\\Users\\jonas\\OneDrive\Dokumenty\\2023\\myW3Schools\\myW3schools-main\\Interface\\jQueryScript\\json\\jsonFiles.json'
        ...
        # odebira data dle "dataJsonFiles.csv"
        odebiraneSekceJson = odebirejDataJsonFiles.odebirejData(jsonFilesSekceNew)
        jsonFilesSekceNew2 = odebiraneSekceJson.getJsonFilesSekceNew()

        #####################    otestovat   ########################

        #vytvori novy jsonFileArr
        jsonFilesArrNew = self.vytvorJsonFileNew(jsonFilesSekceNew2)
        ...
        # tiskne html
        htmlFile.generujHtmlFile(pathJson)
    ...
    def ziskejCestu(self):
        ...
        cestaNew = cestaNew + 'Interface\\jQueryScript\\json\\jsonFiles.json'
